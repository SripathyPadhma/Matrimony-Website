...
<body style=" background-image: linear-gradient(to top, #62f787 0%, #c6e948 100%);">
<% 
...
<c:remove var="error" scope="session"/>
				...
				<div class="field-set">
					...
					<input class="form-input" id="txt-input" type="text"
						placeholder="@UserName" required name="contact"> <br>
					...
					<!--        buttons -->
					<!--      button LogIn -->
					<button style="margin-top: 30px;" type=submit class="log-in">
						Log In</button>
				</div>
				...
				<div class="other">
					...
					<p stle="margin-top:9px
					"  class="btn submits frgt-pass">Don't have an account</p>
					<!--     Sign Up button -->
