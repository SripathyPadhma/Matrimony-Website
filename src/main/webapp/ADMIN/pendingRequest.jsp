...
%>
	...
	<h4  class="text-center ">Pending Request</h4>
	<div class="row">
	<%
	profileDAO D=new profileDAO(DbConnect.getcon());
	List<Users>list1=D.GePendingUsers();
	for(Users u:list1)
	{%>
			...
			<div class="col-md-3">
				<div class="card-container">
					...
					<a class="btn btn-outline-primary" href="inActiveProfile.jsp?ID=<%=u.getId()%>">Show More</a>
