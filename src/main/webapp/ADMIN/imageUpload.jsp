...
<c:remove var="error" scope="session"/>
			...
			<input type="file" placeholder=" image-1" name="profile">
			<input type="file" placeholder="image-2" name="profile">
			<input type="file" placeholder="image-3" name="profile">
			<input type="file" placeholder="image-4" name="profile">
