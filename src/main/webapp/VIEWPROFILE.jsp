...
$(document).ready(function(){
	...
	const myKeey=window.location.search;
	const params=new URLSearchParams(myKeey);
	const profileId=parseInt(params.get('ID'));
	
	$.post( "verify", { id: userid, pid: profileId})
	.done(function( data ) {
...
%>
 ...
 <span class="text-danger">Credits:</span><span id="cred"></span>
...
<div class="container">
						...
						<div class="card-body">
							<div class="d-flex flex-column align-items-center text-center">
								...
								<div class="mt-3">
									...
									<p class="  text-uppercase">Profession:<%=e.getProfession() %></p>
	...
	<button class="btn btn-success" id="show">Show Contact</button>
		...
		#4ff185 50%);" class="card-body">
							...
							var sdata="UID="+id;
							 $.ajax({
								...
								//	var value2 = $("#cred").text();
								    if(value2==0){ 
								    alert("OOPS! You are out of Credits! Please Contact Admin to Recharge");	
								    }
								    else
								    {
